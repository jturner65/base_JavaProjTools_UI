...
import base_UI_Objects.mesh.base.ProcessingShape;
 ...
 */
public class GLPrimitiveProcessingShape extends ProcessingShape implements IMeshInterface {
     ...
     * @param _ri
     */
    public GLPrimitiveProcessingShape(ProcessingRenderer _ri) {       super(_ri, PShape.GROUP);}
    
    /**
     * For Geometry
     * @param _ri
     */
    public GLPrimitiveProcessingShape(ProcessingRenderer _ri, int _type) {super(_ri, _type);}
    /**
     * Creates a processing shape based on gl primitives (built with begin)
     * @param _ri
     * @param family
     */
    public GLPrimitiveProcessingShape(ProcessingRenderer _ri, GL_PrimitiveType meshType) {     super(_ri, getProcFamilyFromGLPrimType(meshType));  }
...
}// class GLPrimitiveProcessingShape
