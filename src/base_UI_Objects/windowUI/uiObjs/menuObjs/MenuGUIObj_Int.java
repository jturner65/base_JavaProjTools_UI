...
public class MenuGUIObj_Int extends Base_NumericGUIObj {
	 ...
	 */
	public MenuGUIObj_Int(int _objID, String _name, myPointf _start, myPointf _end,
			double[] _minMaxMod, double _initVal, boolean[] _flags, double[] _Off, int[] strkClr, int[] fillClr) {
		super(_objID, _name, _start, _end, _minMaxMod, _initVal, GUIObj_Type.IntVal, _flags, _Off, strkClr, fillClr);
	}
