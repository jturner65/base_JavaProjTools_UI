...
public class myGUIObj_Int extends myGUIObj {

	public myGUIObj_Int(IRenderInterface _p, int _objID, String _name, double _xst, double _yst, double _xend,
	...
	@Override
	protected void _drawIndiv() {	p.showText(dispText + String.format("%.0f",val), 0,0);}
