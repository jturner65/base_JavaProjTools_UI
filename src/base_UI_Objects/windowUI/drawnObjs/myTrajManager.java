...
public class myTrajManager {
	...
	protected myDrawnSmplTraj buildTraj(boolean _trajIsFlat) {
		return new myDrawnSmplTraj(ownr, myDispWindow.AppMgr, this, myDispWindow.topOffY,trajFillClrCnst, trajStrkClrCnst, _trajIsFlat, !_trajIsFlat);		
	}
	...
	public void startBuildDrawObj(){
		myDispWindow.AppMgr.setIsDrawing(true);
