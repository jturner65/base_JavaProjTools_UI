...
public class mySidebarMenuBtnConfig {
	/**
	 * set row names for each row of ui action buttons getMouseOverSelBtnLabels()
	...
	public mySidebarMenuBtnConfig(String[] _funcRowNames, String[][] _funcBtnLabels, String[] _debugBtnLabels, boolean _inclWinNames, boolean _inclMseOvValues) {
