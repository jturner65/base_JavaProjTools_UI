...
public class myCntlPt extends myPoint {
	...
	public void drawRad(my_procApplet pa, myVector I, myVector J){
        pa.drawCircle(this, r, I,J,20);
    }
	public void drawBall(my_procApplet pa, int cIdx,myVector I, myVector J) {
	...
	public void drawNorm(my_procApplet pa, int cIdx,myVector I, myVector J) {
