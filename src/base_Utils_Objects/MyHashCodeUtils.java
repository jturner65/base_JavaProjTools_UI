...
* 	derived from http://www.javapractices.com/topic/TopicAction.do?Id=28
*
* Example use case:
* <pre>
*  public int hashCode(){
...
public final class MyHashCodeUtils {	
	...
	*/
	...
	/** doubles. */
	public static int hash(int aSeed , double aDouble) {  return hash( aSeed, Double.doubleToLongBits(aDouble) );}
	...
	*/
	...
	private static int firstTerm(int aSeed){	  return fPrime * aSeed;	}
	
	private static boolean isArray(Object aObject){  return aObject.getClass().isArray();}	
